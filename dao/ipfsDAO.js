    ...
    static async getTokenURI(req, res, next) {
        if(nft_indexes.length >= 1) {
            try {
                ...
                const encrypted_uri = keypub.encrypt(`${baseURL}${i}.json?filename=${i}.json`, 'base64', 'utf8');
                ...
                console.log(generateMetadata(`${baseURL}${i}.json?filename=${i}.json`))
